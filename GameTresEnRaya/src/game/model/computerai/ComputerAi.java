...
public class ComputerAi {
    ...
    /**
     * Represents the turn of the game if computer did no play yet it is zero.
     */
    private byte turn;
     ...
     * @return a SearchAddress type result that represents the line where the three in line is
     * located or free if there is no three in line.
     */
    public SearchAddress movement(Board board, State state) {
        ...
        if (turn < 1) {
            ...
            result = algorithm.movement(board, computerState, state);
        }
        return result;
    }

    /**
     * Sets the turn for test motives only
     * @param newTurn 
     */
